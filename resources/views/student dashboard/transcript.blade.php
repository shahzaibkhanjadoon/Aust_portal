...
<!-- external css (courses css is used as external css) --> 
...
<div id="transcript_on_small_screen">
   <!-- bootstrap alert  code  -->
<div class="alert alert-info alert-dismissible mt-3" role="alert">
Please view transcript on large devices like(tablets , laptops , desktops)
  
  </button>
</div>
</div>
 <!--card for transcript  start -->
 <div id="courses" class="card transcript_on_large_screen">

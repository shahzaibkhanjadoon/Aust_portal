...
<link rel="stylesheet" href="{{asset('student files/css/student login.css')}}">
...
{{Session::get('success')}}
  ...
  <div class="row"> <!--row for content start-->
    <div id="login" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><!--col for content start-->
      ...
      <span  class="card-title mt-3">Student Login</span> <!--card title-->
        ...
        @endif
        <!-- {{ isset($guard) ? url($guard.'/login') : route('login') }} (dafault auth route)  -->
        ...
        <!-- form start  -->
          ...
          @csrf
            ...
            <div class="mb-3">
            <input type="number" class="form-control" id="roll_no" name="roll_no" min="1" required autofocus placeholder="Enter Your roll no">

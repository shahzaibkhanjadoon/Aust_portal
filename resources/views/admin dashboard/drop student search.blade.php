...
<div class="row mb-4"><!-- heading row start -->
    <div class="col-12">
      <h2 class="fw-bolder">Search Drop Student Report:</h2>
    </div> 
  </div>  <!-- heading row end -->
 
  <div class="row"><!-- search row start -->
    <div class="col-12">
      <form action="{{route('droped_student')}}" method="post">
          @csrf
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    <div class="col-12">
      <div id="filters" class="card"><!-- card for filters start  -->
        <span class="card-title">Search droped students from class by using  Filters</span>
        <div class="card-body"> <!-- card body for filters start -->
       <form action="{{route('class_droped_students')}}" method="post"> <!-- forms for filters start -->
       @csrf

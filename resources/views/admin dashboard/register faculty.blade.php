...
<!-- content section start -->
  <div class="row"><!-- heading row start -->
    <div class="col-12">
      <h2 class="fw-bolder">Register Faculty member:</h2>
...
{{Session::get('success')}}
  ...
  <form action="{{route('register_faculty')}}" method="post" enctype="multipart/form-data"> 
      @csrf 
  ...
  <div id="regform" class="row"> <!-- row 1 for registration form start -->
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"> <!-- col for registration form start -->
      <div class="card"> <!-- card for personal info form start -->
       <h2 class="fw-bolder card-title text-center bg-primary">Enter faculty member email to register </h2>
       <div class="card-body"><!-- card body for personal info form start -->
        
            <input type="email" class="form-control" id="email" name="email" placeholder="Enter faculty email">
            @error('email')

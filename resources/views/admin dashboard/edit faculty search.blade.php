...
<div class="row"><!-- heading row start -->
    <div class="col-12">
      <h2 class="fw-bolder">Edit  Faculty:</h2>
    </div> 
  </div>  <!-- heading row end -->
 
  <div class="row"><!-- search row start -->
    <div class="col-12">
      <form action="{{route('edit_faculty')}}" method="post">
          @csrf
        <input type="email" class="form-control" id="search" name="email"  placeholder="Search by email">

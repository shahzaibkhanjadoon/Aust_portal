...
<section id="contentarea"> 
  <div class="row mb-5"><!-- heading row start -->
    <div class="col-12">
      <h2 class="fw-bolder">Assign Class To Student:</h2>
...
{{Session::get('fail')}}
  ...
  <div class="row" id="assignclass"><!-- assign class row start -->
    <div class="col-12"> <!-- assign class col start -->
      ...
      <form action="{{route('assign_class_insert')}}" method="post"> <!-- assign class form start -->
      @csrf
        <label for="roll_no">Roll no.:</label>
        <input type="number" id="roll_no" name="roll_no" placeholder="Enter Student Roll no.">
        @error('roll_no')
  ...
  <span class="text-danger">{{ $message }}</span>
  @enderror
        <button type="submit" class="btn btn-success mt-4 fw-bolder">Assign Class</button>

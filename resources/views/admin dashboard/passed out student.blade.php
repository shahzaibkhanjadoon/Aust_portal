        ...
        <div class="card-body"> <!--card body for record table end-->
          ...
          <table id="recordtable" class="table table-striped table-hover">
            ...
            <tbody>
              <tr>
                <th>Name</th>
                <td>{{$passed_students->name}}</td>
              </tr>
              <tr>
                <th>Father Name</th>
                <td>{{$passed_students->father_name}}</td>
              </tr>
              <tr>
                <th>Gender</th>
                <td>{{$passed_students->Gender}}</td>
              </tr>
             
              <tr>
                <th>Nationality</th>
                <td>{{$passed_students->Nationality}}</td>
              </tr>
              <tr>
                <th>CNIC</th>
                <td>{{$passed_students->CNIC}}</td>
              </tr>
              <tr>
                <th>Date of Birth</th>
                <td>{{$passed_students->Date_of_Birth}}</td>
              </tr>
              <tr>
                <th>Phone</th>
                <td>{{$passed_students->phone_no}}</td>
              </tr>
              <tr>
                <th>Releigon</th>
                <td>{{$passed_students->Religion}}</td>
              </tr>
            ...
            <tbody>
              <tr>
                <th>Roll no</th>
                <td>{{$passed_students->roll_no}}</td>
              </tr>
              <tr>
                <th>Admission date</th>
                <td>{{$passed_students->Admission_date}}</td>
              </tr>
              <tr>
                <th>SSC Degree name</th>
                <td>{{$passed_students->ssc_degree_name}}</td>
              </tr>
              <tr>
                <th>SSC Degree Board</th>
                <td>{{$passed_students->ssc_board_name}}</td>
              </tr>
              <tr>
                <th>SSC Total Marks</th>
                <td>{{$passed_students->ssc_total_marks}}</td>
              </tr>
              <tr>
                <th>SSC Obtained Marks</th>
                <td>{{$passed_students->ssc_obt_marks}}</td>
              </tr>
              <tr>
                <th>HSSC Degree name</th>
                <td>{{$passed_students->hssc_degree_name}}</td>
              </tr>
              <tr>
                <th>HSSC Degree Board</th>
                <td>{{$passed_students->hssc_board_name}}</td>
              </tr>
              <tr>
                <th>HSSC Total Marks</th>
                <td>{{$passed_students->hssc_total_marks}}</td>
              </tr>
              <tr>
                <th>HSSC Obtained Marks</th>
                <td>{{$passed_students->hssc_obt_marks}}</td>
              </tr>
            </tbody>
            <thead>
              <tr >
            ...
            <tbody>
              <tr>
                <th>City Adress</th>
                <td>{{$passed_students->city}}</td>
              </tr>
              <tr>
                <th>Mailing Adress</th>
                <td>{{$passed_students->mailing_adress}}</td>
              </tr>
              <tr>
                <th>Domicile District</th>
                <td>{{$passed_students->domicile_district}}</td>
              </tr>
              <tr>
                <th>Domicile Privience</th>
                <td>{{$passed_students->domicile_province}}</td>
              </tr>
              <tr >
                <thead>
                <th  scope="col">Passed From:</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <th>Programme</th>
                <td>{{$passed_students->programme}}</td>
              </tr>
              <tr>
                <th>Session</th>
                <td>{{$passed_students->session}}</td>
              </tr>
              <tr>
                <th>Year</th>
                <td>{{$passed_students->year}}</td>
              </tr>
              <tr>
                <th>semester</th>
                <td>{{$passed_students->semester}}</td>
              </tr>
              <tr>
                <th>Section</th>
                <td>{{$passed_students->section}}</td>
              </tr>
              <tr>
                <th>CGPA</th>
                <td>{{$passed_students->cgpa}}</td>
              </tr>

...
<div id="result" class="card mb-5">
                <span class="card-title text-start mb-2">Terminal result:</span>
                 ...
                 <div class="card-body">
                  ...
                  <form action="{{route('add_result_logic')}}" method="post"> <!-- form of assignment result start  -->
                   ...
                   <input type="hidden" value="{{$terminal}}" name="type">
                  ...
                  <div class="input mb-4">
                    ...
                    <input type="number" name="tot_marks" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Enter Total Marks" id="total_marks">
                  </div>
        ...
        <!-- date of assignment end  -->
                ...
                <input type="number" step=".01" name="obt_marks[]" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="obtained marks">

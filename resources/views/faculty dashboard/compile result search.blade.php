...
<div id="filters" class="card"><!-- card for filters start  -->
            <span class="card-title">Apply  filters compile course result</span>
            <div class="card-body"> <!-- card body for filters start -->
           <form action="{{route('compile_result')}}" method="post"> <!-- forms for filters start -->
           @csrf
          ...
          <option value="BSSE">MPHIL SE</option>
            ...
            <button id="search_button" type="submit" class="btn btn-primary"><i class="fa-solid fa-filter"></i>Compile</button>
